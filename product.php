				...
				<div class="row">
                    ...
                    <div class="col-md-5">
						<div class="product-details">
							...
							<div>
								<h3 class="product-price">Ksh'.$row['product_price'].'<del class="product-old-price">Ksh1500.00</del></h3>
						...
						<div id="product-tab">
							...
							<div class="tab-content">
								...
								<div id="tab2" class="tab-pane fade in">
									<div class="row">
										<div class="col-md-12">
										<p>Quaality Goods and Services  Valued .</p>	
										</div>
									</div>
								</div>
								<!-- /tab2  -->
												...
												<ul class="reviews">
													...
													<li>
														<div class="review-heading">
															...
															<p class="date">9 DEC 2018, 8:0 PM</p>
															<div class="review-rating">
																<i class="fa fa-star"></i>
																<i class="fa fa-star"></i>
																<i class="fa fa-star"></i>
                        ...
                        echo "
								...
								<a href='product.php?p=$pro_id'><div class='product'>
									...
									<div class='product-body'>
										...
										<h4 class='product-price header-cart-item-info'>$pro_price<del class='product-old-price'>Ksh 1500.00</del></h4>
										<div class='product-rating'>
											<i class='fa fa-star'></i>
											<i class='fa fa-star'></i>
											<i class='fa fa-star'></i>
